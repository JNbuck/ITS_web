...
public class RedisUtil {
    ...
    /**
     * 向一张hash表中放下数据，如果不存在将创建
     * @param key   键
     * @param item  项
     * @param value 值
     * @param time  时间（秒） 注意：如果已存在的hash表有时间，这里将会替换原来的时间
     * @return  true成功 false失败
     */
